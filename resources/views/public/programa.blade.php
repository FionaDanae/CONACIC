                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4 mt-4">
                                    <a href="https://dcytic2.webex.com/dcytic2/j.php?MTID=m0fa3cc4403c2e070199fbe2158c0823c" class="inline-block bg-[#23b0d8] text-white px-4 py-2 rounded-lg hover:bg-[#1a8bb0] transition-colors">Ingresar al Taller</a>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4 mt-4">
                                    <a href="#" class="inline-block bg-[#23b0d8] text-white px-4 py-2 rounded-lg hover:bg-[#1a8bb0] transition-colors">Ingresar al Taller</a>
