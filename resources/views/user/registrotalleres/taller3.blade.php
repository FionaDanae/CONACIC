...
<div class="min-h-screen relative">
    ...
    <div class="relative z-10 container mx-auto px-4 py-16">
        <div class="max-w-3xl mx-auto bg-white/95 backdrop-blur-sm rounded-lg shadow-xl p-8">
            ...
            <h3 class="text-2xl font-bold text-[#1669bc] text-center mb-6">Taller de Inteligencia Artificial y Machine Learning</h3>
            ...
            @if($registro)
                ...
                <div class="mt-6 p-4 bg-gray-100 rounded-lg">
                    ...
                    <p class="text-gray-600">Computadora con Python instalado, Jupyter Notebook, librerías de ML (scikit-learn, pandas, numpy), conocimientos básicos de programación</p>
                </div>
            ...
            @else
                ...
                <form action="{{ route('registrarTaller3') }}" method="POST" class="space-y-6">
                    @csrf
                    <!-- Datos del usuario -->
                    <div class="space-y-6">
